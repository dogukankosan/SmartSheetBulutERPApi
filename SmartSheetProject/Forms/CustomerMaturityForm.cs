            ...
            try
            {
                ...
                foreach (var row in vadeResult.Data)
                {
                    ...
                    Dictionary<string, object> satir = new Dictionary<string, object>
                    {
                        ...
                        ["CARIBAKIYE"] = ToDecimal(GetVal(row, "CariBakiye", 0)),
                        ["CARIUSD"] = ToDecimal(GetVal(row, "CariUSD", 0)),
                        ["CARIEURO"] = ToDecimal(GetVal(row, "CariEURO", 0)),
                        ["CARIGBP"] = ToDecimal(GetVal(row, "CariGBP", 0)),
                        ["VADESIGECMISBAKIYE"] = ToDecimal(GetVal(row, "VadesiGecmisTL", 0)),
                        ["VADESIGECMISUSD"] = ToDecimal(GetVal(row, "VadesiGecmisUSD", 0)),
                        ["VADESIGECMISEURO"] = ToDecimal(GetVal(row, "VadesiGecmisEURO", 0)),
                        ["VADESIGECMISGBP"] = ToDecimal(GetVal(row, "VadesiGecmisGBP", 0)),
                    };
